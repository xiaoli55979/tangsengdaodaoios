...
/// 转让群组身份
/// @param groupNo 群编号
/// @param toUid 需要接受的成员编号
/// @param complete <#complete description#>
- (void)groupManager:(nonnull WKGroupManager *)manager groupNo:(nonnull NSString *)groupNo toUid:(nonnull NSString *)toUid complete:(void (^ _Nullable)(NSError * _Nullable))complete;
...
/// 转让群主
- (void)groupNo:(NSString *)groupNo toUid:(NSString *)toUid complete:(void (^)(NSError * _Nonnull))complete;
/**
 群设置
