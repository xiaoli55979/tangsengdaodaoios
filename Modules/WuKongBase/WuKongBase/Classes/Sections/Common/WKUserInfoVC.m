...
-(BOOL) forbiddenAddFriend {
    BOOL status = self.viewModel.fromChannelInfo && self.viewModel.fromChannelInfo.extra[@"forbidden_add_friend"]?[self.viewModel.fromChannelInfo.extra[@"forbidden_add_friend"] boolValue]:false;
    return status;
}
