...
- (void)grounSetting:(WKConversationSettingVM *)vm {
    printf("grounSetting");
}

- (void)settingMember:(WKConversationSettingVM *)vm {
    __weak typeof(self) weakSelf = self;
...
- (void)removeMember:(WKConversationSettingVM *)vm {
    __weak typeof(self) weakSelf = self;
...
/// 转让群组身份
- (void)changeGroupMember:(WKConversationSettingVM *)vm {
    __weak typeof(self) weakSelf = self;
